...
import {FRAttack} from "./FreeRiderAttack.sol";
...
contract FreeRiderChallenge is Test {
    ...
    function test_freeRider() public checkSolvedByPlayer {
        // Deploy and invoke the attack contract
        FRAttack frattack = new FRAttack(uniswapPair, marketplace, weth, nft, recoveryManager);
        frattack.attack();
    }
